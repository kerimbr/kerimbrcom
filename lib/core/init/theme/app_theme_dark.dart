...
import 'package:kerimbr_com/core/init/theme/app_theme.dart';

class AppThemeDark extends AppTheme{
  static AppThemeDark? _instance;
  static AppThemeDark? get instance{
    if(_instance == null) _instance = AppThemeDark._init();
    return _instance;
  }
  ...
  ThemeData get theme => ThemeData(
    ...
    toggleableActiveColor: Color( 0xffff9e24 ),
    secondaryHeaderColor: Color( 0xff616161 ),
    textSelectionColor: Color( 0xffff9e24 ),
    cursorColor: Color( 0xffe88202 ),
    textSelectionHandleColor: Color( 0xffff9e24 ),
    backgroundColor: Color( 0xff616161 ),
    dialogBackgroundColor: Color( 0xff424242 ),
    indicatorColor: Color( 0xffff9e24 ),
